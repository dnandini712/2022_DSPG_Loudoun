...
```{r}
ggplot(summed_edu3,aes(Label, edu_sum)) + geom_col(fill = "skyblue") + theme(axis.text.x = element_text(angle=0)) +labs(x = "Qualification", y = "Number of population", caption = " Source : DP03 ACS 5-yr data 2016-2020", title = "Education Qualification") + coord_flip()
```
