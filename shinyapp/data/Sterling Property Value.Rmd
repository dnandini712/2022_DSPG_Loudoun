...
#dfpv = c('Less than $50,000', '$50,000 to $99,000', '$100,000 to $149,999', '$150,000 to $199,999', '$200,000 to $299,999', '$300,000 to $499,999', '$500,000 to $999,999', '$1,000,000 or more')
#Numberpv = c(58,6,46,204,1137,4653,709,26)

#figPV <- plot_ly(type='funnelarea', labels=dfpv, values=Numberpv, sort = FALSE, direction = "",
               #textinfo='percent',
...
figpv <- dfpv %>% plot_ly(labels = ~Valuepv, values = ~Numberpv, sort = FALSE, textinfo = "percent", direction = "anitclockwise",hoverinfo = 'text', text = ~paste('Total:', Numberpv))
figpv <- figpv %>% add_pie(hole = 0.5)
figpv <- figpv %>% layout(title = "Property Value", showlegend = T, autosize = FALSE,
                      xaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE),
                      yaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE))

figpv

dfpv <- read_excel(paste0(getwd(), "/Property_Value.xlsx"), col_names = TRUE)
Numberpv=c(58,6,46,204,1137,4653,709,26)
