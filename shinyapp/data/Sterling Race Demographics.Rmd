...
figR <- plot_ly(type='pie', labels=labelsR, values=valuesR, 
               ...
               insidetextorientation='radial') %>% layout(title ='', legend=list(title=list(text='Select Race')))
...
HispanicPercentagePIE <- plot_ly(type='pie', labels=labelsHispanicPIE, values=valuesHispanicPIE, 
               ...
               hoverinfo = 'text', 
               text = ~paste('Total Population:', valuesHispanicPIE)) %>% layout(title ='Hispanic Population In Sterling', legend=list(title=list(text='')))
