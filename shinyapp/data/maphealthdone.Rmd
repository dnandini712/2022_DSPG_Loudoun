...
addCircleMarkers(data=healthfree,~Longitude,~Latitude,popup = ~popups, label = ~as.character(Name),group = ~Resource,color = ~pal(Resource),weight = 7, radius=7, 
                stroke = F, fillOpacity = 1) %>%
#addCircleMarkers(data=healthpay,~Longitude,~Latitude,popup = ~popups,label = ~as.character(Name),group = "Not Free", weight = 7, radius=7, 
                #stroke = F, fillOpacity = 1, color = "#2e850a") %>% 
