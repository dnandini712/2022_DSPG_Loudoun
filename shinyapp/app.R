...
genders<- ggplot(data=genders, aes(x=School, y=Total, fill = forcats::fct_rev(Sex), group=Sex, width=0.9)) +
  ...
  scale_fill_manual(values = c('#20AFCC','#F56D4F')) + labs(y="Total Students", x="", fill="")+ggtitle("Gender 2021-2022") + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
...
racenine <- ggplot(nineteensub,aes(x=School,y=Percentage,fill=Race, group=Race))+ geom_col(position = "dodge",aes(text = paste0("Percentage:",Percentage, "%", "\n","Race:",Race,"\n","School:",School)))+labs(title="Race/Ethnicity Demographics 2019-2020",y="Percentage",x = "",caption = "Source: VDOE Fall Membership Report 2016-2020") + theme(plot.caption.position = "plot",
