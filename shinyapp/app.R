                            ...
                            tabPanel("Mental Health", 
                                     ...
                                     fluidPage(style = "margin: 2px;", 
                                               ...
                                               column(6, 
                                                      ...
                                                      p("Mental health services can improve behavior, attendance, performance, and overall well-being. Thus, timely mental health services can drastically improve a student's performance. Furthermore, offering family members mental health services can also provide students with a safer and healthier home environment.  "),
                                                      p("We categorize mental health services in and around the Sterling area into four categories: Anger Management, Bereavement, Family Counseling, and Family Therapy. There are only two mental health services available in a 10-minute driving radius. Only three anger management services are within a 45-minute radius of the Sterling area. However, numerous family therapy options exist, including family counseling, relationship counseling, and children's counseling. However, the availability of these mental health services may be reduced if they require health insurance.")
                                                  )
                            ...
                            tabPanel("Family Engagement",
                                     ...
                                     fluidPage(style = "margin: 2px;", 
                                               ...
                                               column(6, 
                                                      ...
                                                      p((""), align = "justify"),
                                                      p("Engaging family members such as parents, siblings, grandparents, and neighbors can help create a neighborhood with goals and strategies to ensure student success. These individuals can work together to help monitor students' progress and provide early intervention guidance if necessary. Informed and increase family engagement can improve attendance rates and academic achievement. Additionally, providing adults with educational opportunities can spur students' performance. "),
                                                      p("There are few services within a 20-minute driving range that provides families with employment and educational enrichment services. Moreover, resources that offer emergency housing facilities and assistance with rent and utilities are mainly around the Leesburg area. Thus, community schools can potentially help families within this area, given the limited access. Housing and Holiday Help are also outside of the Sterling Area except for INMED Family Homelessness Prevention And Intervention Program and Tin Cup Fund/Women Giving Back, respectively.")
                                               )
                            ...
                            tabPanel("Youth Development",
                                     ...
                                     fluidPage(style = "margin: 2px;", 
                                               ...
                                               column(6, 
                                                      ...
                                                      p("Students from low-income communities tend to have limited access to activities outside of school which can widen the achievement gap. Services or programs where students can develop social, emotional, physical, and academic skills can improve a student’s performance and behavior. These include athletic events, academic and non-academic clubs, after-school programs, and family resources."),
                                                      p("The listing here is not exhaustive as we were unable to attain data on the listing of after-school programs/clubs at each elementary school. However, we present an external after-school program. CASA is a licensed after-school program that provides students with activities and a fun environment during parents’ work. CASA services two elementary schools with YMCA in the four other schools. YMCA along with Sterling Library offers activities and support in areas such as homework, sports, and fitness, conversation groups, book clubs, art classes, and more. The Inova Healthy Plate Club is a club that is also close to a majority of the community Schools. They provide cooking classes for healthy eating throughout the week.")
                                                )),
