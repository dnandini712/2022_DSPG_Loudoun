...
figSTM <- plot_ly(dataSTAFF, x = ~Schools, y = ~Teachers, type = 'bar', name = 'Teachers')
figSTM <- figSTM %>% add_trace(y = ~Staff, name = 'Staff')
figSTM <- figSTM %>% layout(yaxis = list(title = 'Count'), barmode = 'stack')
