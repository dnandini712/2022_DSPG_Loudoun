...
library(plotrix)
slices.GENDER <- c(50.5, 49.5)
lbls.GENDER <- c("Males 50.5%", "Females 49.5%")
pie3D(slices.GENDER,labels=lbls.GENDER,explode=0.1,
   main="Source: DP05 ACS 5-yr 2016-2020") 
...
figG <- plot_ly(type='pie', labels=labelsG, values=valuesG, 
               ...
               insidetextorientation='radial') %>% layout(title ='Gender Percentage', legend=list(title=list(text='Gender')))
