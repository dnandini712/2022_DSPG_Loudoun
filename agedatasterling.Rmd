...
ggplot(subset_sterling,aes(x=age_cat,y=age_estimate, fill=age_cat))+geom_col()+theme(axis.text.x=element_text(size=7.5, face="bold"),axis.text.y = element_blank(),axis.ticks.y=element_blank())+scale_x_discrete(limits=age_cat)+labs(title="Age Demographics of Sterling, VA",subtitle="2016-2020",caption= "Source: S0101 ACS data 2016-2020",x="Age Group",y="Estimated Percent of Population",) + coord_polar() + guides(fill = guide_legend(title = "Age Group")) 
