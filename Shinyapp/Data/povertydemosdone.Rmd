...
library(dplyr)
library(tidyverse)
read_excel("~/Downloads/DSPG-R-Training/2022_DSPG_Loudoun/shinyapp/data/povertybyageandsexnewss.xlsx", 
    sheet = "Data")
poverty_as <- read_excel("~/Downloads/DSPG-R-Training/2022_DSPG_Loudoun/shinyapp/data/povertybyageandsexnewss.xlsx", 
    sheet = "Data")
```
...
subtitle="Income in the past 12 months below poverty level",
remove age 

"Under 5 years", "5 years","6 to 11 years","12 to 14 years","15 years","16 to 17 years","18 to 24 years","25 to 34 years","35 to 44 years","45 to 54 years","55 to 64 years","65 to 74 years","75 years and older"
...
plot_ly(subset_poverty_as, x = ~cat, y = ~Total, color = ~Sex, type = "bar", hoverinfo = "text",text = ~paste("Age:",cat,"<br>","Total:",Total,"<br>","Sex:",Sex)) %>% layout(title = "Poverty by Age and Sex",xaxis = list(title="",barmode = "group", categoryorder = "array", categoryarray = ~cat))
```
